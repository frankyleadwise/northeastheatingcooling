...
export const metadata: Metadata = {
  title: 'HVAC Service Areas in Tampa Bay, FL',
  description:
      ...
      <main>
        ...
        <div className="absolute inset-0">
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            <p className="text-slate-300 text-sm font-semibold uppercase tracking-widest mb-3">
              Tampa Bay's Trusted HVAC Company
            </p>
            <h1 className="font-display text-4xl sm:text-5xl font-extrabold leading-[1.05] mb-5 tracking-[-0.03em]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="tel:8132916146"
                className="inline-flex items-center gap-2 bg-white text-[#0f1620] font-bold px-7 py-3.5 rounded-lg hover:bg-[#C8330A]/5 transition-colors shadow-lg text-lg"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 bg-[#C8330A] hover:bg-[#b02c08] text-white font-bold px-7 py-3.5 rounded-lg transition-colors shadow-lg text-lg border border-[#C8330A]/40"
              >
        ...
        <section className="bg-white py-16 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="font-display tracking-[-0.03em] text-4xl sm:text-5xl font-extrabold text-[#0f1620] mb-4 leading-[1.02]">
              ...
              <div className="space-y-4">
                <div className="bg-[#fff6f1] border border-[#C8330A]/15 rounded-xl p-6">
                  <h3 className="font-bold text-[#0f1620] mb-3 text-lg">Why Choose North East Heating And Cooling?</h3>
                  <ul className="space-y-2.5">
                    {[
                      ...
                      <li key={item} className="flex items-start gap-2 text-gray-700 text-sm">
                        <svg className="w-5 h-5 text-[#C8330A] shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                        {item}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="bg-[#0f1620] text-white rounded-xl p-5 text-center">
                  <p className="text-slate-300 text-sm mb-1">Call us anytime</p>
                  <a href="tel:8132916146" className="text-2xl font-extrabold hover:text-[#F0A06A] transition-colors">
                    (813) 291-6146
                  </a>
                  <p className="text-slate-400 text-xs mt-1">Available for emergency service</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white py-12 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="font-display tracking-[-0.02em] text-2xl sm:text-3xl font-extrabold text-[#0f1620] mb-2">
                Our Service Area
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
              {cities.map((city) => (
                <Link
                  ...
                  className="group bg-white border border-gray-200 rounded-xl p-5 hover:border-[#C8330A]/40 hover:shadow-lg transition-all duration-200"
                >
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-10 h-10 bg-[#C8330A]/10 group-hover:bg-[#b02c08] rounded-lg flex items-center justify-center transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-[#C8330A] group-hover:text-white transition-colors" aria-hidden="true"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
                    </div>
                    <div>
                      <h3 className="font-bold text-[#0f1620] group-hover:text-[#C8330A] transition-colors mb-1">
                        {city.name}, FL
                      </h3>
                      <p className="text-gray-500 text-sm leading-snug">{city.desc}</p>
                    </div>
                  </div>
                  <div className="mt-3 text-[#C8330A] group-hover:text-[#b02c08] text-sm font-semibold flex items-center gap-1 transition-colors">
                    View Services
        ...
        <section className="bg-white py-16 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="font-display tracking-[-0.03em] text-4xl sm:text-5xl font-extrabold text-[#0f1620] mb-3 leading-[1.02]">Our Coverage Area</h2>
            ...
            {/* Map placeholder */}
            <div className="relative w-full h-80 sm:h-96 bg-gradient-to-br from-[#0f1620] via-[#131c2a] to-[#1a2638] rounded-2xl overflow-hidden shadow-xl flex flex-col items-center justify-center text-white">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-16 h-16 text-slate-400 mb-4" aria-hidden="true"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
              <h3 className="text-2xl font-extrabold mb-2">Tampa Bay, FL</h3>
              <p className="text-slate-300 text-center max-w-xs px-4 text-sm">
              ...
              <div className="mt-4 flex flex-wrap justify-center gap-2 px-6">
                {['Tampa', 'St. Pete', 'Clearwater', 'Brandon', 'Riverview', 'Valrico', 'Plant City', 'Apollo Beach', 'Gibsonton', 'Ruskin'].map((city) => (
                  <span key={city} className="bg-[#C8330A]/60 text-white text-xs px-2.5 py-1 rounded-full border border-[#C8330A]/40/40">
                    {city}
                  </span>
                ))}
              </div>
        ...
        <section className="bg-gray-50 py-16 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="font-display tracking-[-0.03em] text-4xl sm:text-5xl font-extrabold text-[#0f1620] mb-3 leading-[1.02]">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <Link
                  key={service.title}
                  href={service.href}
                  className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-[#C8330A]/40 hover:shadow-md transition-all"
                >
                  <h3 className="font-bold text-[#0f1620] text-lg mb-2 group-hover:text-[#C8330A] transition-colors">
                    {service.title}
                  </h3>
                  <p className="text-gray-600 text-sm leading-relaxed">{service.desc}</p>
                  <span className="mt-3 inline-block text-[#C8330A] text-sm font-semibold group-hover:text-[#b02c08] transition-colors">
                    Learn more &rarr;
                  </span>
                </Link>
              ))}
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              ...
              <div className="text-white">
                ...
                <div className="space-y-3">
                  <a href="tel:8132916146" className="flex items-center gap-3 text-white hover:text-[#F0A06A] transition-colors">
                    <div className="w-10 h-10 bg-[#C8330A] rounded-lg flex items-center justify-center shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.4 2 2 0 0 1 3.6 1.22h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.8a16 16 0 0 0 6.29 6.29l.95-.95a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                    </div>
                    <div>
                      <p className="text-slate-300 text-xs">Call us anytime</p>
                      <p className="font-bold text-xl">(813) 291-6146</p>
                    </div>
                  </a>
                  <a href="mailto:office@northeastheatingcooling.com" className="flex items-center gap-3 text-white hover:text-[#F0A06A] transition-colors">
                    <div className="w-10 h-10 bg-[#C8330A] rounded-lg flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <p className="text-slate-300 text-xs">Email us</p>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl">
                <h3 className="text-[#0f1620] font-bold text-xl mb-4">Request a Free Consultation</h3>
                <form className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label htmlFor="sa-first-name" className="block text-sm font-medium text-gray-700 mb-1">First Name</label>
                      <input id="sa-first-name" type="text" placeholder="John" className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#C8330A] focus:border-transparent" />
                    </div>
                    <div>
                      <label htmlFor="sa-last-name" className="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                      <input id="sa-last-name" type="text" placeholder="Smith" className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#C8330A] focus:border-transparent" />
                    </div>
                  </div>
                  <div>
                    <label htmlFor="sa-phone" className="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                    <input id="sa-phone" type="tel" placeholder="(813) 555-0123" className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#C8330A] focus:border-transparent" />
                  </div>
                  <div>
                    <label htmlFor="sa-email" className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                    <input id="sa-email" type="email" placeholder="john@example.com" className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#C8330A] focus:border-transparent" />
                  </div>
                  <div>
                    <label htmlFor="sa-city" className="block text-sm font-medium text-gray-700 mb-1">Your City</label>
                    <select id="sa-city" className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#C8330A] focus:border-transparent text-gray-700">
                  ...
                  <div>
                    ...
                    <textarea id="sa-message" rows={3} placeholder="Describe your HVAC issue or project..." className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#C8330A] focus:border-transparent resize-none" />
                  </div>
                  <button
                    type="submit"
                    className="w-full bg-[#C8330A] hover:bg-[#b02c08] active:bg-[#0f1620] text-white font-bold py-3 rounded-lg transition-colors text-base shadow-sm"
                  >
                    Send Request
                  </button>
