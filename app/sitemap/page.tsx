...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: '24/7 Emergency AC Repair Tampa', href: '/residential/emergency-ac-repair-tampa' },
      { label: 'AC Installation Tampa, FL', href: '/residential/hvac-installation-tampa-fl' },
      { label: 'AC Replacement Tampa', href: '/residential/ac-replacement-tampa' },
      { label: 'AC Maintenance & Tune-Up Tampa', href: '/residential/ac-maintenance-tampa' },
      { label: 'Heat Pump Installation & Repair Tampa', href: '/residential/heat-pump-tampa' },
      { label: 'Ductless Mini-Split Tampa', href: '/residential/ductless-mini-split-tampa' },
      { label: 'Indoor Air Quality Tampa', href: '/residential/indoor-air-quality-tampa' },
      { label: 'Smart Thermostat Installation Tampa', href: '/residential/smart-thermostat-installation-tampa' },
      ...
      { label: 'Dryer Vent Cleaning Tampa', href: '/residential/dryer-vent-cleaning-tampa' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Commercial AC Replacement Tampa', href: '/commercial/ac-replacement-tampa' },
      { label: '24/7 Emergency Commercial HVAC Tampa', href: '/commercial/emergency-hvac-tampa' },
