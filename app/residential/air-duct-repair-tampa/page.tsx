      ...
      <section className="bg-blue-50 border-y border-blue-100 py-10 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/service-areas" className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-white border border-blue-200 text-blue-700 font-semibold text-sm rounded-lg hover:bg-blue-700 hover:text-white hover:border-blue-700 transition-colors shadow-sm">
