...
const faqs = [
  ...
  },
  {
    ...
    a: "HVAC repair costs vary widely depending on the issue — minor electrical components are on the simpler end, while compressor or refrigerant work is more involved. We diagnose first, then give you a flat-rate quote upfront that you approve before any work begins.",
  },
  {
  ...
  return (
    <main className="font-sans">
      ...
      <section className="relative bg-[#0f1620] text-white py-20 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            ...
            alt="HVAC technician performing AC repair in Tampa Bay FL"
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <p className="inline-flex items-center gap-2.5 text-[0.72rem] font-bold tracking-[0.18em] uppercase mb-4 text-[#F0A06A]">
            <span className="w-7 h-px bg-[#F0A06A]/40" aria-hidden="true" />Tampa Bay, FL — Residential HVAC Repair
          </p>
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-[-0.03em] leading-[1.0] mb-5">
            Professional Residential <span className="text-[#F47438]">HVAC Repair</span> Services in Tampa, FL
          </h1>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <p className="inline-flex items-center gap-2.5 text-[0.72rem] font-bold tracking-[0.18em] uppercase mb-4 text-[#C8330A]">
            <span className="w-7 h-px bg-[#C8330A]/40" aria-hidden="true" />Tampa Bay HVAC repair
          </p>
          <h2 className="font-display text-4xl sm:text-5xl font-extrabold tracking-[-0.03em] leading-[1.02] text-slate-900 mb-8">
            Tampa Bay&rsquo;s <span className="text-[#C8330A]">Trusted</span> Residential HVAC Repair Team
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="bg-[#fff6f1] rounded-2xl p-7 border border-[#C8330A]/15">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="flex items-center justify-center gap-2.5 text-[0.72rem] font-bold tracking-[0.18em] uppercase mb-4 text-[#C8330A]">
              <span className="w-7 h-px bg-[#C8330A]/40" aria-hidden="true" />What we fix<span className="w-7 h-px bg-[#C8330A]/40" aria-hidden="true" />
            </p>
            <h2 className="font-display text-4xl sm:text-5xl font-extrabold tracking-[-0.03em] leading-[1.02] text-slate-900 mb-3">Our HVAC <span className="text-[#C8330A]">Repair</span> Services</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl sm:text-5xl font-extrabold tracking-[-0.03em] leading-[1.02] text-slate-900 mb-5">
                HVAC Repair in Florida&rsquo;s <span className="text-[#C8330A]">Demanding Climate</span>
              </h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                >
                  <div className="font-display text-3xl font-extrabold text-[#F47438] mb-1">{stat.value}</div>
      ...
      <section className="bg-white py-16 px-4 border-t border-gray-100">
        <div className="max-w-5xl mx-auto">
          <p className="flex items-center justify-center gap-2.5 text-[0.72rem] font-bold tracking-[0.18em] uppercase mb-4 text-[#C8330A]">
            <span className="w-7 h-px bg-[#C8330A]/40" aria-hidden="true" />Most common<span className="w-7 h-px bg-[#C8330A]/40" aria-hidden="true" />
          </p>
          <h2 className="font-display text-4xl sm:text-5xl font-extrabold tracking-[-0.03em] leading-[1.02] text-slate-900 mb-3 text-center">Common AC Repairs <span className="text-[#C8330A]">We Handle</span></h2>
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <p className="flex items-center justify-center gap-2.5 text-[0.72rem] font-bold tracking-[0.18em] uppercase mb-4 text-[#C8330A]">
            <span className="w-7 h-px bg-[#C8330A]/40" aria-hidden="true" />The honest difference<span className="w-7 h-px bg-[#C8330A]/40" aria-hidden="true" />
          </p>
          <h2 className="font-display text-4xl sm:text-5xl font-extrabold tracking-[-0.03em] leading-[1.02] text-slate-900 mb-3 text-center">
            Why Choose North East Heating And Cooling for <span className="text-[#C8330A]">HVAC Repair?</span>
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div className="w-10 h-10 rounded-full bg-[#C8330A]/10 flex items-center justify-center mb-4">
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="font-display text-4xl sm:text-5xl font-extrabold tracking-[-0.03em] leading-[1.02] text-slate-900 mb-3 text-center">
            Frequently Asked Questions — <span className="text-[#C8330A]">HVAC Repair</span> in Tampa
          </h2>
      ...
      <section id="contact-form" className="bg-[#0f1620] py-16 px-4 text-white">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="font-display text-4xl sm:text-5xl font-extrabold tracking-[-0.03em] leading-[1.02] mb-4">Schedule Your HVAC Repair <span className="text-[#F47438]">Today</span></h2>
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: { '@type': 'Answer', text: 'HVAC repair costs vary widely depending on the issue — minor electrical components are on the simpler end, while compressor or refrigerant work is more involved. We diagnose first, then give you a flat-rate quote upfront that you approve before any work begins.' },
              },
              {
                '@type': 'Question',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'HVAC Service & Repair Tampa' },
            ],
          }),
        }}
      />
