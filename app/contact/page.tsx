    ...
    <>
      ...
      <section className="bg-red-600 text-white py-5 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            href="tel:8132916146"
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-red-600 font-extrabold rounded-xl text-base hover:bg-red-50 transition-colors whitespace-nowrap shadow-md"
          >
            <PhoneIcon />
            (813) 291-6146
          </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-16">
            ...
            >
              ...
              <p className="text-xl font-extrabold text-gray-900 group-hover:text-white transition-colors">
                (813) 291-6146
              </p>
              <p className="text-sm text-gray-500 group-hover:text-blue-100 mt-1 transition-colors">
                24/7 Emergency Line
              </p>
            </a>
            ...
            >
              ...
              <p className="text-base font-extrabold text-gray-900 group-hover:text-white transition-colors break-all">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <p className="text-xs text-gray-400 text-center">
                    Your information is never shared or sold. We only use it to
