      ...
      const AlertIcon = () => (
        ...
        const MapPinIcon = () => (
          ...
          const CheckIcon = () => (
            ...
            // ─── Data ────────────────────────────────────────────────────────────────────
const serviceAreas = [
    'Tampa, FL', 'Brandon, FL', 'Riverview, FL', 'Wesley Chapel, FL',
    'Clearwater, FL', 'St. Petersburg, FL', 'Largo, FL', 'Palm Harbor, FL',
    'Pinellas Park, FL', 'Carrollwood, FL', 'Lutz, FL', 'Land O Lakes, FL',
    'Odessa, FL', 'New Port Richey, FL', 'Apollo Beach, FL', 'Sun City Center, FL',
    'Ruskin, FL', 'Gibsonton, FL', 'Valrico, FL', 'Plant City, FL',
  ]
  const serviceTypes = [
      'AC Repair', 'AC Installation', 'Heating Repair', 'Air Duct Repair',
      'Exhaust Fan Repair', 'Water Heater Repair', 'Commercial HVAC', 'Other',
    ]
                                    ...
                                    <section className="bg-red-600 text-white py-5 px-4">
                                            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                                                      <div className="flex items-center gap-3 text-center sm:text-left">
                                                                  <AlertIcon />
                                                                  <div>
                                                                                <p className="font-extrabold text-lg leading-tight">HVAC Emergency? We&apos;re Available 24/7</p>p>
                                                                                <p className="text-red-100 text-sm">AC down in the Tampa heat? Don&apos;t wait — call us now for immediate response.</p>p>
                                                                  </div>div>
                                                      </div>div>
                                    ...
                                    <section className="section-padding bg-white">
                                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                                      <div className="text-center mb-12">
                                                                  <p className="text-blue-600 font-semibold text-sm uppercase tracking-widest mb-2">Get in Touch</p>p>
                                                                  <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Contact Information</h2>h2>
                                                      </div>div>
                                                      ...
                                                      <div className="grid sm:grid-cols-3 gap-6 mb-16">
                                                        {/* Phone */}
                                                                  <a href="tel:8132916146" className="group flex flex-col items-center text-center p-8 rounded-2xl border-2 border-blue-100 bg-blue-50 hover:border-blue-500 hover:bg-red-600 hover:text-white transition-all shadow-sm">
                                                                                <div className="w-16 h-16 flex items-center justify-center rounded-2xl bg-red-600 group-hover:bg-white text-white group-hover:text-blue-600 mb-4 transition-colors"><PhoneIcon /></div>div>
                                                                                <p className="text-xs font-bold uppercase tracking-widest text-blue-500 group-hover:text-blue-100 mb-1 transition-colors">Call Us</p>p>
                                                                                <p className="text-xl font-extrabold text-gray-900 group-hover:text-white transition-colors">(813) 291-6146</p>p>
                                                                                <p className="text-sm text-gray-500 group-hover:text-blue-100 mt-1 transition-colors">24/7 Emergency Line</p>p>
                                                                  </a>a>
                                                        {/* Email */}
                                                                  <a href="mailto:office@northeastheatingcooling.com" className="group flex flex-col items-center text-center p-8 rounded-2xl border-2 border-blue-100 bg-blue-50 hover:border-blue-500 hover:bg-red-600 hover:text-white transition-all shadow-sm">
                                                                                <div className="w-16 h-16 flex items-center justify-center rounded-2xl bg-red-600 group-hover:bg-white text-white group-hover:text-blue-600 mb-4 transition-colors"><MailIcon /></div>div>
                                                                                <p className="text-xs font-bold uppercase tracking-widest text-blue-500 group-hover:text-blue-100 mb-1 transition-colors">Email Us</p>p>
                                                                                <p className="text-base font-extrabold text-gray-900 group-hover:text-white transition-colors break-all">office@northeastheatingcooling.com</p>p>
                                                                                <p className="text-sm text-gray-500 group-hover:text-blue-100 mt-1 transition-colors">We reply within 1 business day</p>p>
                                                                  </a>a>
                                                        {/* Hours */}
                                                                  <div className="flex flex-col items-center text-center p-8 rounded-2xl border-2 border-blue-100 bg-blue-50 shadow-sm">
                                                                                <div className="w-16 h-16 flex items-center justify-center rounded-2xl bg-red-600 text-white mb-4"><ClockIcon /></div>div>
                                                                                <p className="text-xs font-bold uppercase tracking-widest text-blue-500 mb-1">Business Hours</p>p>
                                                                                <div className="space-y-1 text-sm text-gray-700">
                                                                                                <p className="font-semibold text-gray-900">Mon – Fri: 7:00 AM – 7:00 PM</p>p>
                                                                                                <p className="font-semibold text-gray-900">Saturday: 8:00 AM – 5:00 PM</p>p>
                                                                                                <p className="font-bold text-red-600">Emergency: 24 / 7 Available</p>p>
                                                                                </div>div>
                                                                  </div>div>
                                                      </div>div>
                                              ...
                                              {/* ── Contact Form + Map ────────────────────────────────────────── */}
                                                      <div className="grid lg:grid-cols-2 gap-12">
                                                        {/* Form */}
                                                                  <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
                                                                                <h2 className="text-2xl font-extrabold text-gray-900 mb-2">Send Us a Message</h2>h2>
                                                                                <p className="text-gray-500 text-sm mb-6">Fill out the form and we&apos;ll get back to you shortly.</p>p>
                                                ...
                                                <div className="flex flex-col items-center justify-center text-center py-12 gap-4">
                                                                  ...
                                                                  <h3 className="text-xl font-extrabold text-gray-900">Message Received!</h3>h3>
                                                                  <p className="text-gray-500 max-w-xs">Thank you for reaching out. A member of our team will contact you within 1 business day.</p>p>
                                                                  <p className="text-sm text-gray-400">
                                                                                      For immediate help, call{' '}
                                                                                      <a href="tel:8132916146" className="text-blue-600 font-semibold">(813) 291-6146</a>a>
                                                                  </p>p>
                                                </div>div>
                                              ) : (
                                                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                                                                  ...
                                                                  <div className="grid sm:grid-cols-2 gap-4">
                                                                                      <div>
                                                                                                            <label htmlFor="phone" className="block text-sm font-semibold text-gray-700 mb-1.5">
                                                                                                                                    Phone <span className="text-red-500">*</span>span>
                                                                                                              </label>label>
                                                                                                            <input
                                                                                                                                      id="phone"
                                                                                                                                      name="phone"
                                                  ...
                                                  {/* Preferred Contact Method */}
                                                                  <div>
                                                                                      <p className="block text-sm font-semibold text-gray-700 mb-2">Preferred Contact Method</p>p>
                                                                          ...
                                                                          <label key={method} className="flex items-center gap-2 cursor-pointer">
                                                                                                    <input
                                                                                                                                ...
                                                                                                                                />
                                                                                                    <span className="text-sm text-gray-700">{method}</span>span>
                                                                          </label>label>
                                                                        ))}
                                                                                        </div>div>
                                                                  </div>div>
                                                                  ...
                                                                  <div className="flex flex-col gap-8">
                                                                    {/* Google Maps embed */}
                                                                                <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-sm">
                                                                                                <div className="bg-blue-50 px-5 py-3 border-b border-gray-200 flex items-center justify-between">
                                                                                                                  <div>
                                                                                                                                      <p className="font-bold text-gray-800 text-sm">North East Heating And Cooling</p>p>
                                                                                                                                      <p className="text-gray-500 text-xs">12831 Buffalo Run Dr, Gibsonton, FL 33534</p>p>
                                                                                                                    </div>div>
                                                                                                                  <a href="https://www.google.com/maps/place/North+East+Heating+And+Cooling/@27.8027777,-82.3512035,17z/data=!4m6!3m5!1s0x2003b66f381708c5:0xb21d6d85ffd57b3c!8m2!3d27.8027777!4d-82.3512035!16s%2Fg%2F11ldsk9rrj" target="_blank" rel="noopener noreferrer" className="text-xs font-semibold text-blue-700 hover:text-blue-900 underline whitespace-nowrap">
                                                                                                                                      Open in Maps ↗
                                                                                                                    </a>a>
                                                                                                  </div>div>
                                                                                                <iframe
                                                                    ...
                                                                    {/* Service Areas */}
                                                                                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                                                                                                <h3 className="font-extrabold text-gray-900 text-lg mb-4">Areas We Serve</h3>h3>
                                                                                                <ul className="grid grid-cols-2 gap-x-4 gap-y-2">
                                                                                                  {serviceAreas.map((city) => (
                                                    <li key={city} className="flex items-center gap-2">
                                                                          <CheckIcon />
                                                                          <span className="text-sm text-gray-600">{city}</span>span>
                                                    </li>li>
                                                  ))}
                                                                                                  </ul>ul>
                                                                                                <p className="text-xs text-gray-400 mt-4">
                                                                                                                  Don&apos;t see your city?{' '}
                                                                                                                  <a href="tel:8132916146" className="text-blue-600 font-semibold hover:underline">Call us</a>a>{' '}
