...
export default function FinancingPage() {
  return (
    <main className="bg-white">
      ...
      >
        <div className="absolute -top-32 -right-24 w-[30rem] h-[30rem] rounded-full blur-3xl pointer-events-none" style={{ background: "#C8330A", opacity: 0.08 }} aria-hidden="true" />
        <div className="absolute -top-20 -left-24 w-[26rem] h-[26rem] rounded-full blur-3xl pointer-events-none" style={{ background: "#2563eb", opacity: 0.05 }} aria-hidden="true" />
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <RevealWrapper>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-[-0.03em] leading-[1.05] mb-6 text-slate-900">
              Get comfortable now.<br />
              <span className="text-[#C8330A]">Pay for it over time.</span>
            </h1>
            <p className="text-lg sm:text-xl leading-relaxed max-w-3xl mx-auto mb-9 text-slate-600">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-4 text-base font-bold text-white rounded-full bg-[#C8330A] hover:bg-[#b02c08] shadow-lg shadow-[#C8330A]/20 transition-colors"
              >
                Apply for Financing
                <ArrowIcon />
              </a>
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-4 text-base font-semibold rounded-full text-slate-800 bg-white border border-slate-300 hover:border-slate-400 hover:bg-slate-50 transition-colors"
              >
      ...
      {/* ── BENEFITS ───────────────────────────────────────────────────────── */}
      <section className="py-20 sm:py-24 bg-white" aria-label="Why finance your HVAC system">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {benefits.map(({ Icon, title, desc }, i) => (
              <RevealWrapper key={title} delay={i * 80}>
                <div className="h-full rounded-2xl p-7 bg-white border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl mb-5 bg-[#C8330A]/10 text-[#C8330A]">
                    <Icon />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-bold text-white rounded-full bg-[#C8330A] hover:bg-[#b02c08] shadow-lg shadow-[#C8330A]/20 transition-colors"
            >
            ...
            {financeable.map(({ label, href }, i) => (
              <RevealWrapper key={label} delay={i * 50}>
                ...
                >
                  ...
                  <span className="text-[#C8330A]"><ArrowIcon className="w-4 h-4" /></span>
                </Link>
              </RevealWrapper>
            ))}
          </div>
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-4 text-base font-semibold rounded-full text-slate-800 bg-white border border-slate-300 hover:border-slate-400 transition-colors"
                  >
                    <PhoneIcon />
                    (813) 291-6146
                  </a>
      ...
      {/* ── FAQ ────────────────────────────────────────────────────────────── */}
      <section className="py-20 sm:py-24 bg-slate-50 border-t border-slate-200" aria-label="HVAC financing FAQ">
            ...
            {faqs.map(({ q, a }) => (
              <details key={q} className="group rounded-xl overflow-hidden bg-white border border-slate-200">
                <summary className="flex items-center justify-between gap-4 cursor-pointer list-none px-6 py-5 text-base font-semibold text-slate-900">
                  {q}
                  <span className="shrink-0 transition-transform duration-200 group-open:rotate-45 text-[#C8330A]" aria-hidden="true">
      ...
      {/* ── DISCLOSURE ─────────────────────────────────────────────────────── */}
      <section className="py-12 bg-white" aria-label="Financing disclosure">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
