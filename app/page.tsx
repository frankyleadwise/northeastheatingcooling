...
import { REVIEW_COUNT } from '@/lib/business'
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed max-w-xl mb-8 text-slate-600">
                Honest flat-rate pricing, licensed and insured technicians, and {REVIEW_COUNT}
              ...
              <div className="flex flex-wrap items-center gap-x-5 gap-y-3 text-sm">
                <span className="flex items-center gap-1.5">
                  ...
                  <span className="text-slate-500">&middot; {REVIEW_COUNT} reviews</span>
                </span>
            ...
            <div className="relative">
              ...
              <div className="hidden sm:flex items-center gap-2.5 absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl ring-1 ring-black/5 pl-3.5 pr-4 py-3">
                ...
                <span className="text-sm font-semibold text-slate-800">5.0 &middot; {REVIEW_COUNT} Google reviews</span>
              </div>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: `${REVIEW_COUNT} five-star reviews from real Tampa Bay customers — every single one.`,
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-300 text-lg">
              <span className="text-amber-400 font-bold">★★★★★</span> 5.0 Average Rating · {REVIEW_COUNT} Google Reviews
            </p>
          </div>
