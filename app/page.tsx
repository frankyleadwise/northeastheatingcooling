...
export default function HomePage() {
  return (
    <main>
      {/* ── HERO ── */}
      <section className="relative min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700 flex items-center overflow-hidden" aria-label="Hero">
        {/* Background pattern */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <span className="inline-flex items-center gap-1.5 bg-blue-800/60 border border-blue-600/40 text-blue-100 text-sm font-medium px-3 py-1.5 rounded-full">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
              Expert HVAC Services You Can{' '}
              <span className="text-blue-300">Trust</span> in Tampa Bay
            </h1>
            <p className="text-lg sm:text-xl text-blue-100 leading-relaxed mb-8 max-w-2xl">
              Dependable heating, cooling, and indoor air quality solutions for Florida homes and businesses — fast repairs, quality installations, and routine maintenance from North East Heating &amp; Cooling.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 bg-white text-blue-900 font-bold text-lg px-8 py-4 rounded-lg hover:bg-blue-50 transition-colors shadow-lg"
              >
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 text-blue-200 text-sm font-medium">
